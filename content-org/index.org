...
Știrile sunt grupate în Buletine Cosmice, distribuit sub formă de [[https://buletin.parsec.ro/][newsletter]] sau [[https://buletin.parsec.ro/notes][notițe]].
...
** Lansări 2024
:PROPERTIES:
:EXPORT_FILE_NAME: 2024
:EXPORT_TITLE: Lansări orbitale 2024
:END:

În anul 2024, au avut loc un total de src_emacs-lisp[:results value raw]{2024-total} tentative de lansări orbitale, din care src_emacs-lisp[:results value raw]{2024-failures} eșecuri.

#+BEGIN_SRC emacs-lisp :results raw :exports results
(table-launches-year "2024")
#+END_SRC

#+BEGIN_SRC emacs-lisp :results raw :exports results
  (list-launches-for-year "2024" 0 2 3 4 5 6 8 12 13 '("ID" "Dată (UTC)" "Lansator" "V" "Serie" "Misiune" "Centru" "TR" "R"))
#+END_SRC
...
** Starship
:PROPERTIES:
:EXPORT_FILE_NAME: starship
:END:

#+BEGIN_SRC emacs-lisp :results silent :exports results
  (setq rocket "Starship")
  (counts-for-rocket rocket)
#+END_SRC
